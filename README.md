...
:wrench: Herramientas utilizadas: <br><br>
  ...
  :small_orange_diamond: Github <br>
<br>
:clapper:Tutoriales utilizados: <br><br>

  :small_orange_diamond: Curso COMPLETO de GIT y GITHUB desde CERO para PRINCIPIANTES <br>
    https://www.youtube.com/watch?v=3GymExBkKjE <br>
  :small_orange_diamond: Curso GIT y GITHUB - Tutorial desde CERO <br>
    https://www.youtube.com/playlist?list=PLQxX2eiEaqby-qh4raiKfYyb4T7WyHsfW <br>
  :small_orange_diamond: Programando un Menu en C++ con RLUtil <br>
    https://www.youtube.com/watch?v=l7x72honaD0&list=PLf1pCPM0y_dd80hZaqJOr5Hnr80G1ASkH&index=6 <br> <br>

:computer: Webs utilizadas: <br>

   :small_orange_diamond: ASCII Chart <br>
    https://microsoft.github.io/makecode-csp/unit-6/day-12/ascii-chart <br>
    :small_orange_diamond: Texto a Voz <br>
    https://luvvoice.com/es <br>
   :small_orange_diamond: Complete list of github markdown emoji markup <br>
    https://gist.github.com/rxaviers/7360908 <br><br>
