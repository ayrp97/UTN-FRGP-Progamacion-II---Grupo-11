...
void menuGestor(){
    ...
    int corteMenu  = 1;    //Se declara y se asigna un valor a la variable de corte del Do While que contendr� todo el menu del programa
    ...
    while (corteMenu !=0){
        ...
        rlutil::locate(46,17);  cout << "ADMINISTRACION DE SALAS DE CINE";
